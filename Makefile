...
ARMLTD_BRANCH = 090727_armdev
ARMLTD_RELEASE = AEL-3.1_rc1
...
LIBS += fs/cramfs/libcramfs.a fs/fat/libfat.a fs/fdos/libfdos.a fs/jffs2/libjffs2.a \
	...
	fs/ubifs/libubifs.a fs/ext4/libext4fs.o
LIBS += net/libnet.a
LIBS += disk/libdisk.a
...
#
# Note the kludge to prevent failing due to missing version file
# after a distclean
#
...
ns2816_yangcheng_config: unconfig
	@$(MKCONFIG) $(@:_config=) arm ns2816 yangcheng  nufront

ns2816_huashan_config: unconfig
	@$(MKCONFIG) $(@:_config=) arm ns2816 huashan nufront


ns2816_test_config: unconfig
	@$(MKCONFIG) $(@:_config=) arm ns2816 test nufront


ns2816_dev_config: unconfig
	@$(MKCONFIG) $(@:_config=) arm ns2816 dev nufront

ns2816_demo_config: unconfig
	@$(MKCONFIG) $(@:_config=) arm ns2816 demo nufront


ns2816_ntnb_config: unconfig
	@$(MKCONFIG) $(@:_config=) arm ns2816 ntnb nufront

ns2816_ntpad_config: unconfig
	@$(MKCONFIG) $(@:_config=) arm ns2816 ntpad nufront
...
clean:
	...
	@rm -f $(obj)board/cray/L1/{bootscript.c,bootscript.image}	  \
	       ...
	       $(obj)board/armltd/integrator/u-boot.lds                   \
	       $(obj)include/armltdvc_autogenerated.h                     \
