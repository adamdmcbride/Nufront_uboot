...
#endif
#ifdef	CONFIG_STDIN
	"stdin="	MK_STR(CONFIG_STDIN)		"\0"
#endif
#ifdef	CONFIG_STDOUT
	"stdout="	MK_STR(CONFIG_STDOUT)		"\0"
#endif
#ifdef	CONFIG_STDERR
	"stderr="	MK_STR(CONFIG_STDERR)		"\0"
#endif
#ifdef	CONFIG_RECOVEYBOOT
	"recoveryboot="	MK_STR(CONFIG_RECOVERYBOOT)		"\0"
#endif
#ifdef	CONFIG_RECOVEYARGS
	"recoveryargs="	MK_STR(CONFIG_RECOVERYARGS)		"\0"
#endif
