...
#define CONFIG_EXTRA_ENV_SETTINGS       \
	...
	"pmem_base=0xb1800000\0" \
        ...
        "default_bootargs=setenv bootargs console=ttyS0,115200 pmem=${pmem_base} root=/dev/mmcblk1p2 rw rootwait mem=792M init=/init video=nusmartfb:${lcdres} wifiethaddr=${wifimac}\0" \
