...
#define CONFIG_EXTRA_ENV_SETTINGS      \
       ...
       "resolution=1024x600\0" \
        ...
        "default_bootargs=setenv bootargs console=ttyS0,115200 pmem=${pmem_base} root=/dev/mmcblk1p2 rw rootwait mem=824M video=nusmartfb:${resolution}-${dispformat} init=/init\0" \
