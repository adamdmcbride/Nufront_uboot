...
/* Responses */
#define RSP_TYPE_NONE		(RSP_TYPE_NORSP   | CRCCE_NOCHECK | CICE_NOCHECK)
#define RSP_TYPE_R1		(RSP_TYPE_LGHT48  | CRCCE_CHECK   | CICE_CHECK)
#define RSP_TYPE_R1B		(RSP_TYPE_LGHT48B | CRCCE_CHECK   | CICE_CHECK)
#define RSP_TYPE_R2		(RSP_TYPE_LGHT136 | CRCCE_CHECK   | CICE_NOCHECK)
#define RSP_TYPE_R3		(RSP_TYPE_LGHT48  | CRCCE_NOCHECK | CICE_NOCHECK)
#define RSP_TYPE_R4		(RSP_TYPE_LGHT48  | CRCCE_NOCHECK | CICE_NOCHECK)
#define RSP_TYPE_R5		(RSP_TYPE_LGHT48  | CRCCE_CHECK   | CICE_CHECK)
#define RSP_TYPE_R6		(RSP_TYPE_LGHT48  | CRCCE_CHECK   | CICE_CHECK)
#define RSP_TYPE_R7		(RSP_TYPE_LGHT48  | CRCCE_CHECK   | CICE_CHECK)
